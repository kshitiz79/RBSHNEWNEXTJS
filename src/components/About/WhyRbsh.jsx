  ...
  return (
    <section className="relative bg-[#0A0D11] md:h-[120vh] text-white px-6 md:px-12 ">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-stretch min-h-[600px]">
        {/* Left content */}
        <div className="w-full md:w-[70%] 2xl:w-[90%] flex flex-col justify-center space-y-8 pr-6 pb-12">
          <div>
          ...
          <div className="leading-relaxed md:w-[56%] 2xl:w-[70%] self-end md:py-20 py-2 ">
            ...
            <p className="text-gray-300 text-[1.11rem] 2xl:text-xl md:text-justify mt-8">
        ...
        <div className="w-full md:w-[40%] 2xl:w-[60%] relative md:h-full h-full 2xl:h-[90vh] rounded-xl overflow-hidden mt-0 md:mt-4 mb-12 md:ml-2">
          <HoverAnimationImage />
