        ...
        <div className="w-full h-full ">
          ...
          >
            ...
            <motion.div
              ...
              className="md:h-[40vh] h-[60vh] 2xl:h-[200vh] border-[#0A0D11] "
            >
              <motion.video
                src="/ABOUTUS.mp4"
                autoPlay
                ...
                loop
                playsInline
                style={{ height: is2XLScreen ? "135%" : "100%" }}
                className="w-full object-cover  p-6 2xl:p-4  border-b "
              />
            </motion.div>
            ...
            <div className="h-[60vh] px-6">
              <div className="h-full flex flex-col justify-between max-w-2xl ml-auto "> 
                <h2 className="text-[2.4rem] leading-none pt-8 2xl:pt-40 ">
                  We Don’t Just Build We Create Impact
                </h2>
                <p className="text-lg md:pb-28 text-justify ">
