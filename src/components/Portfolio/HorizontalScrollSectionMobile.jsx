...
export default function HorizontalScrollSectionMobile() {
    ...
    // Use spring for smoother scrolling - tuned for maximum silkiness
    const smoothProgress = useSpring(scrollYProgress, {
        stiffness: 60,  // Lowered for a more premium, weighted feel
        damping: 25,   // Higher damping to prevent oscilation/jitter
        restDelta: 0.0001
    });

    // We use vw-based movement instead of percentages to avoid sub-pixel rounding jitters
    const x = useTransform(
        smoothProgress,
        [0, 0.05, 1],
        ["0vw", "0vw", `-${totalWidthVw - 100}vw`]
    );
    ...
    return (
        <section
            ...
            style={{ contain: "paint", perspective: "1000px" }}
        >
